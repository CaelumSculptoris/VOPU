...
| **17 Sep 2026** | The most recent supplied specification, REV6, defines the complete VOPU execution model: a compiled 3D optical bus, frozen volumetric weights, terminal-node GEMM zones, passive epsilon-thresholding, lambda-decay temporal context, and dynamic Q/K cross-phase interaction. | [`Steal Me.pdf`](../Steal%20Me.pdf), document ID SPEC-VOPU-2026-REV6 | Consolidates the concept into an end-to-end architecture and fabrication workflow. |
